...
export const inventoryProducts = [
  {
    name: "H-Pile",
    icon: "/media/products/mcp/h-pile.png",
    image: "/media/products/mcp/h-pile.png",
  },
  {
    name: "Bars",
    icon: "/media/products/mcp/bars.png",
    image: "/media/products/mcp/bars.png",
  },
  {
    name: "Channel",
    icon: "/media/products/mcp/channel.png",
    image: "/media/products/mcp/channel.png",
  },
  {
    name: "Pipe Pile",
    icon: "/media/products/mcp/pipe-pile.png",
    image: "/media/products/mcp/pipe-pile.png",
  },
  {
    name: "Rail Shapes",
    icon: "/media/products/mcp/rail-shapes.png",
    image: "/media/products/mcp/rail-shapes.png",
  },
  {
    name: "Plate",
    icon: "/media/products/mcp/plate.png",
    image: "/media/products/mcp/plate.png",
  },
  {
    name: "Angle",
    icon: "/media/products/mcp/angle.png",
    image: "/media/products/mcp/angle.png",
  },
  {
    name: "Steel Tube",
    icon: "/media/products/mcp/steel-tube.png",
    image: "/media/products/mcp/steel-tube.png",
  },
  {
    name: "Flats",
    icon: "/media/products/mcp/flats.png",
    image: "/media/products/mcp/flats.png",
  },
  {
    name: "Sheet Piling",
    icon: "/media/products/mcp/sheet-piling.png",
    image: "/media/products/mcp/sheet-piling.png",
  },
  {
    name: "Structural Tee",
    icon: "/media/products/mcp/structural-tee.png",
    image: "/media/products/mcp/structural-tee.png",
  },
  {
    name: "Wide Flange",
    icon: "/media/products/mcp/wide-flange.png",
    image: "/media/products/mcp/wide-flange.png",
  },
] as const;
...
export const contact = {
  ...
  subsidiaries: [
    { name: "Matels Trading Division", logo: "/media/logos/TranLogoMW.png" },
    { name: "TITON Grip", logo: "/media/subsidiaries/TITON_Grip.PNG" },
    { name: "Halemark", logo: "/media/subsidiaries/Halemark.PNG" },
    { name: "Consulting Design", logo: "/media/subsidiaries/Consulting_Design.PNG" },
  ],
};
